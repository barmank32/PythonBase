...
@pytest.fixture
def p(m):
    OO000000O00O0OOO0 = fake.pylist(
        nb_elements=fake.pyint(15, 100), value_types=["int"])
...
def f(request):
    ...
    OO00O00OOOO000OOO = {homework .ODD: lambda O0OO0O00O0OOO00OO: O0OO0O00O0OOO00OO % 2 != 0,
                         homework .EVEN: lambda OO0000OO0OO00OO00: OO0000OO0OO00OO00 % 2 == 0, homework .PRIME: ip, }
    OO000O0O00OOO0O0O = fake .pylist(
        nb_elements=fake .pyint(30, 100), value_types=["int"])
    OOOOOO0O0O0OO0O00 = list(
        filter(OO00O00OOOO000OOO[OO0O0O0O0OO000000], OO000O0O00OOO0O0O))
...
def test_filter_numbers(f, m):
    ...
    OOOO0O00O0O0O0000 = homework .filter_numbers(
        OO0O0O000OO00OO0O, OO0OOOOOO0O0OOOO0)
